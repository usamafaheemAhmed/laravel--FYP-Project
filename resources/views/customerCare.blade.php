        ...
        * {
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
          <tr>
            <td style="padding-right: 0px;padding-left: 0px;" align="center">
              ...
              {{-- <img align="center" border="0" src="{{$data['img']}}" alt="Tick Icon" title="Tick Icon" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 14%;max-width: 81.2px;" width="81.2" class="v-src-width v-src-max-width"/> --}}
        ...
        <table id="u_content_heading_3" $HipNew style="font-family:"Montserrat",sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
          ...
          <h1 class="v-font-size" style="margin: 0px; line-height: 160%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: "Montserrat",sans-serif; font-size: 33px;"><strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;A new Enquiry From The User</strong></h1>
        ...
        <table $HipNew style="font-family:"Montserrat",sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
          ...
          <h1 class="v-font-size" style="margin: 0px; line-height: 160%; word-wrap: break-word; font-weight: normal; font-family: "Montserrat",sans-serif; font-size: 20px;"><strong style="color:#ffff">    {{$data['userName']}}</strong></h1>
        ...
        <table style="font-family:"Montserrat",sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
          ...
          <div style="color: #f1f8f5; line-height: 200%; text-align: left; word-wrap: break-word;">
            <p style="font-size: 14px; line-height: 200%;"><span style="color: #f7e1b5; font-size: 14px; line-height: 28px;"><strong><span style="font-size: 14px; line-height: 28px;">✓</span></strong> <span style="color: #ecf0f1; font-size: 14px; line-height: 28px;">Email :</span></span>  {{$data['email']}}</p>
        <p style="color: #f1f8f5; font-size: 14px; line-height: 200%;"><span style="color: #f7e1b5; font-size: 14px; line-height: 28px;"><strong>✓</strong></span> Phone Numbe : {{$data['phoneNumber']}}</p>
        <p style="color: #f1f8f5; font-size: 14px; line-height: 200%;"><span style="color: #f7e1b5; font-size: 14px; line-height: 28px;"><strong>✓</strong></span>  Message:  "{{$data['message']}}"</p>
          </div>
        ...
        <div align="center">
               <a href="mailto:{{$data['email']}} " target="_blank" class="v-button" style="box-sizing: border-box;display: inline-block;font-family:"Montserrat",sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFF; background-color: #cca250; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;">
